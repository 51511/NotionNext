...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-TW', // e.g 'zh-TW','en-US'  see /lib/lang.js for more.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是Leaf，歡迎來到我的Blog',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leaf', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一起探索這個世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leaftechblog.cloudns.biz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Leaftechblog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'leaftech.used779@slmails.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/channel/UCBBSE1aPOyrkBTuBD1TQfew', // Youtube主页

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://i.meee.com.tw/UO6Yof2.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email,facebook,twitter,telegram,messenger,line', // 分享的服務，按顺序显示,逗号隔开
  ...
  WIDGET_PET_LINK:
        ...
        'https://imuncle.github.io/live2d/model/shizuku/shizuku.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'Leaftechblog', // 站点描述，被notion中的页面描述覆盖
